...
def _message_key(message: str) -> str | None:
    return {
        ...
        "PM3-Verbindung wird geprueft ...": "operation.pm3ConnectionChecking",
        "Scan wird gestartet ...": "operation.scanStarting",
        "HF/LF-Suche laeuft ...": "operation.scanSearchAuto",
        "HF-Suche laeuft ...": "operation.scanSearchHf",
        "LF-Suche laeuft ...": "operation.scanSearchLf",
        "Erster Chip-Read laeuft ...": "operation.firstReadRunning",
        "Zweiter Chip-Read laeuft ...": "operation.secondReadRunning",
        "Scans werden verglichen ...": "operation.scanCompare",
        "Aktueller Chip wird gelesen ...": "operation.currentChipReading",
        "Aktueller Chip wird vollstaendig gelesen ...": "operation.currentChipFullRead",
