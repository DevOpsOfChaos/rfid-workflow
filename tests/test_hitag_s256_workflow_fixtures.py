...
def test_discovery_service_summary_detects_hitag_s256_plain():
    ...
    assert summary.tag_status == "hitag_s256_plain"
    assert summary.summary == "Hitag S256 Plain tag detected"
    assert summary.next_step == "Read profile or verify blank compatibility"
